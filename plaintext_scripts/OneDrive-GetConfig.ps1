...
.NOTES
    Script Name:    OneDrive-GetConfig.ps1
    ...
    Exit Codes:
        0 - Success (OneDrive monitoring completed)
...
try {
    ...
    # Adjust execution policy if needed
    ...
    # Ensure RunAsUser module is available
    ...
    # Define script block to execute as current user
    Write-Log "" -Level INFO
