...
<#
.SYNOPSIS
    Forcefully closes all Microsoft Office and Teams applications.

.DESCRIPTION
    This script terminates running instances of Microsoft Office applications and Microsoft Teams.
    Useful for performing maintenance tasks, software updates, or troubleshooting when applications
    are locked or unresponsive.
    
    WARNING: This script forcefully terminates processes without saving. Unsaved work will be lost.
    Use with caution and ensure users are aware before running on production systems.

.PARAMETER Applications
    Array of application process names to terminate.
    Default: teams, outlook, excel, winword, powerpnt, onenote, lync
...
.EXAMPLE
    ...
    Forcefully closes all default Microsoft Office applications and Teams.

.EXAMPLE
    .\Process-CloseAllOfficeApps.ps1 -Applications "outlook","teams"
    
    Closes only Outlook and Teams applications.

.EXAMPLE
    .\Process-CloseAllOfficeApps.ps1 -WaitForExit 10
...
.NOTES
    File Name      : Process-CloseAllOfficeApps.ps1
...
.FUNCTIONALITY
    - Terminates Microsoft Office application processes
    - Terminates Microsoft Teams processes
    - Supports both graceful and forced termination
    - Reports success/failure for each application
    - Prevents data loss by warning users
#>

[CmdletBinding()]
param(
    [Parameter()]
    [string[]]$Applications = @('teams', 'outlook', 'excel', 'winword', 'powerpnt', 'onenote', 'lync'),
...
process {
    try {
        ...
        Write-Log 'WARNING: This will forcefully close Office applications - unsaved work will be lost' -Level 'WARNING'
    ...
    try {
        ...
        Write-Output "========================================"
        Write-Output "Script: Process-CloseAllOfficeApps.ps1"
