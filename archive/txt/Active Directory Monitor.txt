...
try {
    ...
    Ninja-Property-Set adComputerGroups $computerInfo.GroupsArray
    ...
    Ninja-Property-Set adUserGroups $userInfo.GroupsArray
    ...
    Write-Host "INFO: Computer Groups: $($computerInfo.GroupCount)"
    Write-Host "INFO: User Groups: $($userInfo.GroupCount)"
